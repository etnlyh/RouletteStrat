# Roulette Strategy Analysis: Monte Carlo Simulation

A Python-based simulation engine designed to quantify the long-term expected payoffs and volatility of various roulette betting systems (e.g., Martingale, Fibonacci, Labouchere). By running 10,000+ iterations, this tool visualizes the "Gambler's Ruin" and the impact of table limits on account balance sustainability.
